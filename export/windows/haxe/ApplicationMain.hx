...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Flixel Dash", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Flixel Dash", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "162";
		app.meta["company"] = "Juanen100";
		app.meta["file"] = "Flixel Dash";
		app.meta["name"] = "Flixel Dash";
